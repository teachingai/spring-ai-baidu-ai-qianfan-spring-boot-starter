...
public class BaiduAiQianfanImageOptions implements ImageOptions {
    ...
    /**
     * A unique identifier representing your end-user, which can help QianfanAI to monitor
     * and detect abuse.
     */
    @JsonProperty("user")
    private String user;
    ...
    public static class Builder {
        ...
        private final BaiduAiQianfanImageOptions options;

        private Builder() {
            this.options = new BaiduAiQianfanImageOptions();
        }
        ...
        public BaiduAiQianfanImageOptions build() {
            return options;
        }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof BaiduAiQianfanImageOptions that))
            return false;
    ...
    public String toString() {
        return "QianfanAiImageOptions{" + "n=" + n + ", model='" + model + '\'' + ", width=" + width + ", height=" + height
